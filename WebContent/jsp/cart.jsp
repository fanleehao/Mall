					...
					<tbody>					  
						...
						<c:forEach items="${cart.cartItems }" var="item">
							<tr class="active">
								...
								<td width="10%"><input type="text" name="quantity" value="${item.num }"
			...
			<div style="margin-right: 130px;">
				...
				<div
					...
					<a href="${pageContext.request.contextPath}/CartServlet?method=clearCart"
						...
						href="${pageContext.request.contextPath}/OrderServlet?method=addOrder">
...
$(function(){
	...
	$(".delete").click(function(){
		if(confirm("确认删除?")){
			//获取到被删除商品pid
			var pid=this.id;
			window.location.href="/Mall/CartServlet?method=removeCartItem&pid="+pid;
		}
	});
	//清空
	$("#clear").click(function(){
		if(confirm("确认清空?")){
			window.location.href="/Mall/CartServlet?method=clearCart";
		}
	});
});
</script>
